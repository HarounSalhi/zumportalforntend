...
//************************************************ */
    ...
    resetPassword(email: string): Observable<any> {
      ...
      console.log(email)
      // Customize the URL to point to your Django backend
      const resetPasswordUrl = `${this.host}/auth/resetpassword/`;
      console.log(resetPasswordUrl)

      this.http.post(resetPasswordUrl, { "email": email }).subscribe(
        (response) => {
      ...
      return this.http.post(resetPasswordUrl, {"email":email});
  }
    /**
     * Logout the user
     */
   /*  logout() {
    ...
    getUserProfile(): Observable<any> {
      const apiUrl = `${this.host}/auth/listuser/`;
